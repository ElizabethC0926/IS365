...
def train(
    ...
    # Standard SB3 policy_kwargs: net_arch defines the MLP hidden layers.
    # Using "MlpPolicy" string is the most stable approach across SB3 versions.
    # Both PPO/A2C and DQN accept net_arch as a list of hidden layer sizes.
    std_policy_kwargs = {"net_arch": [hidden_dim, hidden_dim]}
    ...
    if algo == "ppo":
        ...
        model = MaskablePPO(
            ...
            vec_env,
            **hp,
            policy_kwargs   = std_policy_kwargs,
            seed            = seed,
            device          = device,
            verbose         = 0,
